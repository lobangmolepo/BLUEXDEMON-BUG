...
console.log(chalk.yellow.bold('Creator DEMON TECH\nFollow my Whatsapp channel\n✅'))
...
success(`1`, `connected 🐥`)
byxx.sendMessage(`2347041039367@s.whatsapp.net`, { text: `💞 *\`ʙʟᴜᴇxᴅᴇᴍᴏɴ ᴛᴇᴄʜ\`* 💞
> 𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆✅ `})
if (autoJoin) {
...
require("./bluexdemon")(byxx, m, store)
} catch (err) {
console.log(err)
}
})
